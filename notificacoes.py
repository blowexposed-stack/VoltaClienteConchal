...
def enviar_whatsapp(celular: str, mensagem: str, nome_cliente: str) -> bool:
    ...
    ─────────────────────────────────────────────────────────────────────────
    INTEGRAÇÃO REAL: substitua pelo conteúdo da sua API preferida.
